...
class DeferShipmentRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets shipmentId
     *
     * @param string $shipmentId Shipment Id <br />The shipment to apply the change to. <br />             <br />The Shipment Id may be an id or a tracking/barcode number.
     *
     * @return $this
     */
     ...
     * Sets shipmentDate
     *
     * @param \DateTime $shipmentDate Shipment Date <br />The new date that the packages are being shipped. <br />The date must not be in the past and cannot be more than 28 days in the future. <br />             <br />Accepted Format: YYYY-MM-DD
     *
     * @return $this
     */
