...
class Destination implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'eoriNumber' => 'string',
        'vatNumber' => 'string',
        'address' => '\RoyalMailV4\ShipmentsApi\Model\ShipmentAddress'
    ];
     ...
     * Sets vatNumber
     *
     * @param string $vatNumber Receiver's Value-Added Tax (VAT) number, if applicable (i.e. if the receiver is a business). If a Receiver VAT number is used for the shipment, it must be provided here and not in the Customs element.
     *
     * @return $this
     */
     ...
     * Gets address
     *
     * @return \RoyalMailV4\ShipmentsApi\Model\ShipmentAddress
     */
     ...
     * Sets address
     *
     * @param \RoyalMailV4\ShipmentsApi\Model\ShipmentAddress $address address
     *
     * @return $this
     */
