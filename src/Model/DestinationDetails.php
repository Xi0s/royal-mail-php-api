...
class DestinationDetails implements ModelInterface, ArrayAccess
{
     ...
     * Sets postcode
     *
     * @param string $postcode Postcode / Zip <br />Required for United Kingdom addresses and some international addresses. <br />The Countries API can be used to check whether postcode/zip code is required for a country.  <br />Up to 20 characters may be allowed, however it is carrier dependent and some carriers may allow less. <br />Royal Mail: 9 characters.
     *
     * @return $this
     */
