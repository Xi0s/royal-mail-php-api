...
class ErrorDetail implements ModelInterface, ArrayAccess
{
     ...
     * Sets errorCode
     *
     * @param string $errorCode Error Code <br />The error code for this error.<br /><br />**E1000** - System error<br />**E1001** - Required field<br />**E1002** - Invalid field<br />**E1003** - Invalid action<br />**E1004** - Item not found<br />
     *
     * @return $this
     */
