 ...
 *
 * @category Class
 * @description The Offline Barcode element is used to create a shipment record for a shipment that had a tracking number allocated outside of PRO SHIPPING.  &lt;br /&gt;Offline Barcoding is only available if it has been activated on your customer account in the GUI.  &lt;br /&gt;If the Offline Barcode information is provided, then Process is the only valid action accepted in the Action field. &lt;br /&gt;\&quot;OfflineBarcode\&quot; has been deprecated. Please use \&quot;OfflineBarcodes\&quot; instead.
 * @package  RoyalMailV4\ShipmentsApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RoyalMailOfflineBarcode implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $packageOccurrence This is used to assign barcodes to the packages. <br />If provided, each package occurrence must be unique.
     *
     * @return $this
     */
     ...
     * Sets trackingNumber
     *
     * @param string $trackingNumber The tracking number to use for the shipment. This will be mandatory for all services that require a 1D barcode.
     *
     * @return $this
     */
     ...
     * Sets uniqueId
     *
     * @param string $uniqueId The unique Id assigned by Royal Mail, either in full (21 characters) or the customer sequence (8 characters).
     *
     * @return $this
     */
